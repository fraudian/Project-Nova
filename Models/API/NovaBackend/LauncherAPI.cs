...
namespace NovaLauncher.Models.API.NovaBackend
{
    ...
    public class LauncherAPI
    {
        ...
        public static async Task<JObject?> GetLauncherInfoAsync(int maxRetries, TextBlock errorTextBlock)
        {
            ...
            // Return a default JSON with Success set to true for offline mode
            string offlineJson = $@"{{""Success"": true, ""LauncherVersion"": ""{Global.LauncherVersion}"",""Launcher"": """",""Installer"": """",""Assets"": """",""News"": {{""NewsId"": ""00000000"",""LauncherUpdates"": [{{""title"": ""Offline"",""description"": ""You are currently in offline mode, some features may be limited"",""url"": """"}}],""ServerUpdates"": []}}}}";
            return JObject.Parse(offlineJson);
        }
